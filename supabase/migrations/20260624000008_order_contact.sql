-- Always store the contact name+phone entered at checkout (for ALL orders,
-- not just guests) so the kitchen always has a callback number.
...
begin
  ...
  -- a contact name + phone is required on every order
  ...
  insert into public.orders (
    ...
    v_code, v_uid, btrim(p_guest_name), btrim(p_guest_phone),
